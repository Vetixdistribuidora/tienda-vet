...
function SkeletonCard() {
  return (
    <div style={{ background: "white", borderRadius: 14, border: "1px solid #e6e2de", overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.07)" }}>
...
function FilaListaProducto({ p, enCarrito, onAgregar, onCambiar, onDetalle, esFav, onToggleFav, searchQuery, tipoCliente, onVerPrecio }: {
  ...
  return (
    <div onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}
      style={{ display: "flex", alignItems: "center", gap: 12, padding: "9px 14px", background: "white", borderRadius: 10, border: `1.5px solid ${hover ? "#f4b8d4" : "#e6e2de"}`, transition: "border-color 0.15s", minWidth: 0, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
...
<script>window.onload=function(){window.print()}</script>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#e8e4df" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 20px", height: 64, display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <div className="header-search" style={{ flex: 1, maxWidth: 500, position: "relative" }}>
            ...
            {searchFocus && !busqueda && busquedasRecientes.length > 0 && (
              <div style={{ position: "absolute", top: "calc(100% + 6px)", left: 0, right: 0, background: "white", border: "1.5px solid #e2e8f0", borderRadius: 11, boxShadow: "0 8px 32px rgba(0,0,0,0.12)", zIndex: 100, overflow: "hidden" }}>
      ...
      {vistaHome && (
        <div>
          ...
          {/* ── VENTAJAS ───────────────────────────────────────────────────── */}
          <div style={{ background: "#f8fafc", borderBottom: "1px solid #e8edf5", padding: "14px 20px" }}>
          ...
          {laboratorios.length > 0 && (
            <div style={{ background: "white", borderTop: "1px solid #eaecf2", borderBottom: "1px solid #eaecf2", padding: "16px 0" }}>
          ...
          {recientesProductos.length > 0 && (
            <div style={{ background: "white", padding: "28px 0 32px", borderBottom: "1px solid #eaecf2" }}>
            ...
            <div style={{ background: "#fffbf5", borderTop: "1px solid #fde68a", borderBottom: "1px solid #fde68a", padding: "28px 0 32px" }}>
              <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 20px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
                ...
                <button onClick={() => { setOrden("stock_asc"); verCatalogo("") }}
                  style={{ padding: "8px 16px", borderRadius: 9, background: "white", border: "1.5px solid #fde68a", color: "#92400e", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>
          ...
          <div style={{ background: "white", padding: "32px 20px 40px" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 10 }}>
                ...
                <button onClick={() => verCatalogo("")}
                  style={{ padding: "9px 20px", borderRadius: 10, background: "white", border: "1.5px solid #e2e8f0", fontSize: 13, fontWeight: 700, color: "#1a2035", cursor: "pointer" }}>
                  Ver todos →
                </button>
              </div>
                ...
                <div style={{ marginBottom: 18, display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  <div className="sort-bar" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      {busqueda && (
                        <button onClick={() => { setBusqueda(""); setBusquedaDelay("") }} style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: 8, padding: "6px 11px", fontSize: 12, fontWeight: 700, color: "#374151", cursor: "pointer" }}>✕ Limpiar</button>
                      )}
                      <button
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      {catDropdownOpen && (
                        <>
                          ...
                          <div style={{ position: "absolute", top: "calc(100% + 6px)", left: 0, background: "white", border: "1.5px solid #e2e8f0", borderRadius: 11, boxShadow: "0 8px 32px rgba(0,0,0,0.12)", zIndex: 100, minWidth: 230, maxHeight: 320, overflowY: "auto", padding: "6px 0" }}>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      {labDropdownOpen && (
                        <>
                          ...
                          <div style={{ position: "absolute", top: "calc(100% + 6px)", left: 0, background: "white", border: "1.5px solid #e2e8f0", borderRadius: 11, boxShadow: "0 8px 32px rgba(0,0,0,0.12)", zIndex: 100, minWidth: 220, maxHeight: 260, overflowY: "auto", padding: "6px 0" }}>
                            <div style={{ padding: "6px 12px 4px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      ...
      {carritoOpen && (
        <>
          ...
          <div className="cart-drawer-anim" style={{ position: "fixed", top: 0, right: 0, bottom: 0, width: "min(440px, 100vw)", background: "white", zIndex: 51, display: "flex", flexDirection: "column", boxShadow: "-8px 0 48px rgba(0,0,0,0.25)" }}>
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: 14 }}>
              {carrito.length === 0 ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {carrito.map(item => (
                    <div key={item.producto.id} style={{ display: "flex", gap: 12, padding: 12, background: "#f8fafc", borderRadius: 12, border: "1px solid #eaecf2" }}>
                      <div style={{ width: 60, height: 60, background: "white", borderRadius: 9, border: "1px solid #eaecf2", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", position: "relative" }}>
            ...
            {carrito.length > 0 && (
              <div style={{ padding: "14px 20px 20px", borderTop: "1px solid #f1f5f9" }}>
                <div style={{ background: "#f8fafc", borderRadius: 11, padding: "12px 14px", marginBottom: 12, border: "1px solid #eaecf2" }}>
      ...
      {checkoutOpen && !pedidoOk && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(10,15,28,0.65)", zIndex: 60, display: "flex", alignItems: "center", justifyContent: "center", padding: 16, backdropFilter: "blur(4px)" }}>
          <div style={{ background: "white", borderRadius: 22, width: "100%", maxWidth: 520, maxHeight: "92vh", overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "0 32px 80px rgba(0,0,0,0.4)" }}>
            ...
            <div style={{ padding: "18px 24px", overflowY: "auto", flex: 1 }}>
              ...
              {/* Resumen */}
              <div style={{ marginTop: 18, background: "#f8fafc", borderRadius: 13, padding: 15, border: "1px solid #eaecf2" }}>
      ...
      {productoDetalle && (() => {
        ...
        return (
          <div className="overlay-anim" style={{ position: "fixed", inset: 0, background: "rgba(10,15,28,0.7)", zIndex: 60, display: "flex", alignItems: "center", justifyContent: "center", padding: 16, backdropFilter: "blur(4px)" }}
            ...
            <div className="modal-scale-anim" style={{ background: "white", borderRadius: 22, width: "100%", maxWidth: 620, maxHeight: "92vh", display: "flex", flexDirection: "column", boxShadow: "0 32px 80px rgba(0,0,0,0.4)", overflow: "hidden" }}>
              ...
              <div style={{ padding: "16px 20px", borderBottom: "1px solid #f1f5f9", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  <button onClick={() => setProductoDetalle(null)} style={{ width: 34, height: 34, borderRadius: 9, border: "1px solid #e2e8f0", background: "#f8fafc", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "#64748b", flexShrink: 0 }}>
                    <IcoClose />
                  </button>
                </div>
              </div>
      ...
      {pedidosOpen && (
        <div className="overlay-anim" style={{ position: "fixed", inset: 0, background: "rgba(10,15,28,0.7)", zIndex: 55, display: "flex", alignItems: "center", justifyContent: "center", padding: 16, backdropFilter: "blur(4px)" }}
          ...
          <div className="modal-scale-anim" style={{ background: "white", borderRadius: 22, width: "100%", maxWidth: 580, maxHeight: "88vh", display: "flex", flexDirection: "column", boxShadow: "0 32px 80px rgba(0,0,0,0.4)", overflow: "hidden" }}>
              ...
              {cargandoPedidos ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {misPedidos.map(pedido => {
                    ...
                    return (
                      <details key={pedido.id} style={{ background: "#f8fafc", border: "1px solid #eaecf2", borderRadius: 13, overflow: "hidden" }}>
      ...
      {catModalOpen && (
        <div className="overlay-anim" style={{ position: "fixed", inset: 0, background: "rgba(10,15,28,0.7)", zIndex: 55, display: "flex", alignItems: "center", justifyContent: "center", padding: 16, backdropFilter: "blur(4px)" }}
          ...
          <div className="modal-scale-anim" style={{ background: "white", borderRadius: 22, width: "100%", maxWidth: 680, maxHeight: "88vh", display: "flex", flexDirection: "column", boxShadow: "0 32px 80px rgba(0,0,0,0.4)", overflow: "hidden" }}>
      ...
      {pedidoOk && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(10,15,28,0.75)", zIndex: 60, display: "flex", alignItems: "center", justifyContent: "center", padding: 16, backdropFilter: "blur(4px)" }}>
          <div style={{ background: "white", borderRadius: 26, padding: "46px 34px 38px", maxWidth: 400, width: "100%", textAlign: "center", boxShadow: "0 32px 80px rgba(0,0,0,0.45)" }}>
